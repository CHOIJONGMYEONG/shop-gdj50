...
public class OrderService {
	...
	public int getOrderOneCustomerAllCount(String customerId) {
		...
		totalRow = ordersDao.selectOrdersOneCustomerAllCount(conn,customerId);
	...
	public List<Map<String,Object>> getOrdersListByCustomeAndImg(String customerId, int rowPerPage, int currentPage){
		Connection conn = null;
		...
		this.ordersDao = new OrdersDao();
			...
			list = ordersDao.selectOrdersListByCustomerAndImg(conn ,customerId, rowPerPage,beginRow);
