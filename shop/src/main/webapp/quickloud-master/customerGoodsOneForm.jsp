			...
			<div class="row">
				...
				<div class="col-xl-7 col-lg-7 col-md-12 col-sm-12">
                    ...
                    <div class="contact_form">
                        <div id="message"></div>
                        <form id="writeForm" class="" action="<%=request.getContextPath()%>/quickloud-master/customerOrderBuyForm.jsp" name="contactform" method="post">
                            <fieldset class="row row-fluid">
                                ...
                                <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                 ...
                                 <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                    <input type="text" value="수량" name="first_name" id="first_name" class="form-control" readonly>
                                </div>
                               <div class="subdiv">
                        <div class="num">
                            <div class="updown">
                                <input type="text" name="p_num1" id="p_num1" size="2" maxlength="10" class="p_num " value="1" onkeyup="javascript:basket.changePNum(1);">
