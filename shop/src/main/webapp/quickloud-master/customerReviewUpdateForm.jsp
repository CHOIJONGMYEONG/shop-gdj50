		...
		<div class="container">
			<div class="section-title text-center">
				<h3>리뷰수정</h3>
					...
					<form action="<%=request.getContextPath()%>/quickloud-master/customerReviewUpdateAction.jsp">
						
						<div class="form-group">
								<div class="col-sm-12">
									<input class="form-control" id="reviewContent" type="text" name="reviewContent">
								</div>
							</div>
							
							<input type="hidden" value="<%=ordersNo%>" name="ordersNo"> 
							<input type="hidden" value="<%=goodsNo%>" name="goodsNo"> 
							<button type="submit" class="btn grd1 effect-1 btn-radius btn-brd">수정</button>
							<a class="btn grd1 effect-1 btn-radius btn-brd"
				href="<%=request.getContextPath()%>/quickloud-master/customerGoodsOneForm.jsp?goodsNo=<%=goodsNo%>">주문목록</a>
					</form>
			</div>
