							...
							<div class="list-domain">
								<ul>
									<li><a
										...
										href="<%=request.getContextPath()%>/customerGoodsList.jsp">누적판매순</a>
									<li>
									<li><a
										class="btn btn-light grd1 effect-1 btn-radius btn-brd"
										href="<%=request.getContextPath()%>/customerGoodsListHot.jsp">인기순</a>
									<li>
									<li><a
										class="btn btn-light grd1 effect-1 btn-radius btn-brd"
										href="<%=request.getContextPath()%>/customerGoodsListHighPrice.jsp">높은가격순</a>
									<li>
									<li><a
										class="btn btn-light grd1 effect-1 btn-radius btn-brd"
										href="<%=request.getContextPath()%>/customerGoodsListRowPrice.jsp">낮은가격순</a>
									<li>
									<li><a
										class="btn btn-light grd1 effect-1 btn-radius btn-brd"
										href="<%=request.getContextPath()%>/customerGoodsListNew.jsp">최신순</a>
									<li>
								</ul>
							</div>
						</div>
								...
								<div class="col-md-3">
									<div class="pricing-table pricing-table-highlighted">
										<div class="pricing-table-header grd1">
											<a
												href="<%=request.getContextPath()%>/customerGoodsOneForm.jsp?goodsNo=<%=m.get("goodsNo")%>">
												<img
