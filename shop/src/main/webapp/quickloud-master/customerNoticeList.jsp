...
<body class="host_version"> 
    ...
    <div class="section lb">
		...
		%>
                  ...
                  <td data-label="DOMAIN NAME" colspan="2"><a href="<%=request.getContextPath()%>/quickloud-master/customerNoticeOneForm.jsp?noticeNo=<%=a.getNoticeNo()%>"><button class="btn btn-success"><%=a.getNoticeTitle()%></button></a> </td>
