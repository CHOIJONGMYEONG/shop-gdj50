		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="contact_form">
					<div id="message"></div>
					<form id="writeForm"
						action="<%=request.getContextPath()%>/quickloud-master/admin/adminCustomerOneUpdate.jsp?customerId=<%=paramCustomer.getCustomerId()%>"
						class="" method="post">
						<fieldset class="row row-fluid">
							...
							<div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
								<input type="text" value="<%=paramCustomer.getCustomerId()%>"
									name="customerId" id="customerId" class="form-control" readonly
									placeholder="">
							</div>
							<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
							...
							<div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
								<input type="password"
									value="<%=paramCustomer.getCustomerPass()%>" name="customerPw"
									id="customerPw" class="form-control" placeholder="">
							</div>
							<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
								<input type="text" value="이름" class="form-control" readonly>
							</div>
							<div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
								<input type="text" value="<%=paramCustomer.getCustomerName()%>"
							...
							<div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
								<input type="text"
									value="<%=paramCustomer.getCustomerAddress()%>"
							...
							<div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
								<input type="text"
									value="<%=paramCustomer.getCustomerTelephone()%>"
							...
							<div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
								<input type="text" value="<%=paramCustomer.getCreateDate()%>"
							...
							<div class="text-center pd">
								<a
									href="<%=request.getContextPath()%>/quickloud-master/admin/adminCustomerList.jsp"><button
										type="button" id="submit"
										class="btn btn-light btn-radius btn-brd grd1 btn-block">고객리스트</button></a>
							</div>
							<div class="text-center pd">
								<a
									href="<%=request.getContextPath()%>/quickloud-master/admin/adminCustomerDeleteAction.jsp?customerId=<%=paramCustomer.getCustomerId()%>"><button
										type="button" id="submit"
										class="btn btn-light btn-radius btn-brd grd1 btn-block">고객탈퇴</button></a>
							</div>
						</fieldset>
					</form>
				</div>
