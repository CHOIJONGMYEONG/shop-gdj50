		...
		<nav class="navbar navbar-expand-lg navbar-light bg-light">
			<div class="container-fluid">
				<a class="navbar-brand"
					href="<%=request.getContextPath()%>/quickloud-master/index.jsp">s
							...
							<div class="list-domain">
								<div class="row">
									...
									<div class="contact_form">
										<div id="message"></div>
										<form id="writeForm"
											action="<%=request.getContextPath()%>/quickloud-master/admin/employeeDeleteAction.jsp"
											class="" method="post">
											<fieldset class="row row-fluid">
												...
												<div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
													<input type="password" value="" name="employeePass"
														id="employeePass" class="form-control" placeholder="">
												</div>


												<div class="text-center pd">
													<button type="submit" id="submit"
														class="btn btn-light btn-radius btn-brd grd1 btn-block">사원탈퇴</button>
												</div>

												<div class="text-center pd">
													<a
														href="<%=request.getContextPath()%>/quickloud-master/admin/adminOneForm.jsp"><button
