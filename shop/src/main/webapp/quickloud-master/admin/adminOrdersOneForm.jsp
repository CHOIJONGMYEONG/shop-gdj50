        ...
        <div class="container">
			...
			<div class="row">
                    ...
                    <div class="contact_form">
                        <div id="message"></div>
                        <form id="writeForm" class="" method="post">
                            <fieldset class="row row-fluid">
                            	
                            	
                            	  <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                    <input type="text" value="주문번호" class="form-control" readonly>
                                </div>
                                <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                    <input type="text" value="<%=orderNo %>"  class="form-control" readonly placeholder="">
                                </div>
                                  <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                    <input type="text" value="고객아이디" class="form-control" readonly>
                                </div>
                                <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                    <input type="text" value="<%=customerId %>"  class="form-control" readonly placeholder="">
                                </div>
                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                    <input type="text" value="고객주소"  class="form-control" readonly>
                                </div>
                                <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                    <input type="text" value="<%=customerAddress %>"  class="form-control" readonly placeholder="">
                                </div>
                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                    <input type="text"value="상품명" class="form-control" readonly>
                                </div>
                                <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                    <input type="text" value="<%=goodsName %>" class="form-control" readonly placeholder="">
                                </div>
                                
                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                    <input type="text" value="상품가격"  class="form-control" readonly>
                                </div>
                                <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                    <input type="text" value="<%=goodsPrice %>"  class="form-control" readonly placeholder="">
                                </div>
                                
                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                    <input type="text" value="주문수량"  class="form-control" readonly>
                                </div>
                                <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                    <input type="text" value="<%=orderQuantity %>"  class="form-control" readonly placeholder="">
                                </div>
                                
                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                    <input type="text" value="주문가격"  class="form-control" readonly>
                                </div>
                                <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                    <input type="text" value="<%=orderPrice %>"  class="form-control" readonly placeholder="">
                                </div>
                                
                                
                           		  <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                    <input type="text" value="주문날짜"  class="form-control" readonly>
                                </div>
                                 <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                    <input type="text" value="<%=OcreateDate%>" class="form-control"  readonly placeholder="">
                                </div>
                                <div class="text-center pd">
                                   <a href="<%=request.getContextPath()%>/quickloud-master/admin/adminOrdersList.jsp"><button type="button" id="submit" class="btn btn-light btn-radius btn-brd grd1 btn-block">주문리스트</button></a> 
                                </div>    
