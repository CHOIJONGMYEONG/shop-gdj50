				...
				<div class="contact_form">
					...
					<form id="writeForm" class="" method="post">
						<fieldset class="row row-fluid">
							...
							<div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
								<input type="text" value="<%=customerId%>" class="form-control"
									readonly placeholder="">
							</div>
							<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
							...
							<div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
								<input type="text" value="<%=goodsName%>" class="form-control"
									readonly placeholder="">
							</div>
							...
							<div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
								<input type="text" value="<%=goodsPrice%>" class="form-control"
									readonly placeholder="">
							</div>
							...
							<div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
								<input type="text" value="<%=orderPrice%>" class="form-control"
									readonly placeholder="">
							</div>
							...
							<div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
								<input type="text" value="<%=OcreateDate%>" class="form-control"
									readonly placeholder="">
							</div>
							<div class="text-center pd">
								<a
									href="<%=request.getContextPath()%>/quickloud-master/admin/adminOrdersList.jsp"><button
										type="button" id="submit"
										class="btn btn-light btn-radius btn-brd grd1 btn-block">주문리스트</button></a>
							</div>
