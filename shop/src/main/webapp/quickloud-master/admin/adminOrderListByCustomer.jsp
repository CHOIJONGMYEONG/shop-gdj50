		...
		<div class="container">
			<div class="section-title text-center">
							...
							<tbody>
								...
								<tr>
									<td data-label="DOMAIN NAME"><a
										href="<%=request.getContextPath()%>/quickloud-master/admin/adminOrdersOneForm.jsp?orderNo=<%=a.get("ordersNo")%>"><button
												class="btn btn-danger"><%=a.get("ordersNo")%></button></a></td>
									...
									<td data-label="DOMAIN NAME" colspan="2">
										<form id="orderStateForm" name="orderStateForm"
											...
											<select name="orderState"
												...
												%>
											</select> <input type="hidden" value="<%=a.get("ordersNo")%>"
												name="orderNo">
				...
				<a class="btn grd1 effect-1 btn-radius btn-brd"
					href="<%=request.getContextPath()%>/quickloud-master/admin/adminOrderListByCustomer.jsp?currentPage=<%=pageBegin - rowPerPage%>">이전</a>
				...
				%>
				<a class="btn grd1 effect-1 btn-radius btn-brd"
					href="<%=request.getContextPath()%>/quickloud-master/adminOrderListByCustomer.jsp?currentPage=<%=i%>"><%=i%></a>
				<%
				}
				...
				<a class="btn grd1 effect-1 btn-radius btn-brd"
					href="<%=request.getContextPath()%>/quickloud-master/admin/adminOrderListByCustomer.jsp?currentPage=<%=pageBegin + rowPerPage%>">다음</a>
				<%
				}
				%>
