		...
		<div class="container">
			<div class="section-title text-center">
							...
							<tbody>
								...
								<tr>
									...
									<td data-label="DOMAIN NAME">
										<form
											action="<%=request.getContextPath()%>/quickloud-master/admin/employeeApprovalAction.jsp"
											method="post">
											...
											%>
											<input type="hidden" value="<%=a.getEmployeeId()%>"
												name="employeeId">
											<button type="submit"
												class="btn grd1 effect-1 btn-radius btn-brd">승인변경</button>
										</form>
									</td>
				...
				<a class="btn grd1 effect-1 btn-radius btn-brd"
					href="<%=request.getContextPath()%>/quickloud-master/admin/employeeList.jsp?currentPage=<%=pageBegin - rowPerPage%>">이전</a>
				...
				<a class="btn grd1 effect-1 btn-radius btn-brd"
					href="<%=request.getContextPath()%>/quickloud-master/admin/employeeList.jsp?currentPage=<%=i%>"><%=i%></a>
				...
				<a class="btn grd1 effect-1 btn-radius btn-brd"
					href="<%=request.getContextPath()%>/quickloud-master/admin/employeeList.jsp?currentPage=<%=pageBegin + rowPerPage%>">다음</a>
				<%
				}
				%>
