			...
			<div class="row">
				<div class="col-xl-6 col-md-12 col-sm-12">
					...
					<div class="contact_form">
						<div id="message"></div>
						<form id="writeForm" enctype="multipart/form-data" class=""
							action="<%=request.getContextPath()%>/quickloud-master/admin/GoodsImgUpdateAction.jsp"
							...
							<fieldset class="row row-fluid">
								...
								<div class="text-center pd">
									<button type="submit" id="submit"
										class="btn btn-light btn-radius btn-brd grd1 btn-block">이미지변경</button>
								</div>
								<div class="text-center pd">
									<a
