		...
		<div class="container">
			<div class="section-title text-center">
				...
				<a class="btn grd1 effect-1 btn-radius btn-brd"
					href="<%=request.getContextPath()%>/quickloud-master/admin/adminNoticeUpdateForm.jsp?noticeNo=<%=noticeParam.getNoticeNo()%>">수정</a>
				<a class="btn grd1 effect-1 btn-radius btn-brd"
					href="<%=request.getContextPath()%>/quickloud-master/admin/adminNoticeDeleteAction.jsp?noticeNo=<%=noticeParam.getNoticeNo()%>">글삭제
				</a>
