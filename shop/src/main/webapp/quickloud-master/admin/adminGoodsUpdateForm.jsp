				...
				<div class="col-xl-7 col-lg-7 col-md-12 col-sm-12">
					...
					<div class="contact_form">
						...
						<form id="writeForm" class=""
							action="<%=request.getContextPath()%>/quickloud-master/admin/adminGoodsUpdateAction.jsp?goodsNo=<%=goodsNo%>"
							...
							<fieldset class="row row-fluid">
								...
								<div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
									<input type="text" value="<%=goodsName%>" name="goodsName"
										id="goodsName" class="form-control" placeholder="">
								</div>
								<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
								...
								<div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
									<input type="text" value="<%=goodsPrice%>" name="goodsPrice"
										id="goodsPrice" class="form-control" placeholder="">
								</div>
								<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
								...
								<div class="text-center pd">
									<button type="submit" id="submit"
										class="btn btn-light btn-radius btn-brd grd1 btn-block">수정하기</button>
								</div>

								<div class="text-center pd">
									<a
										href="<%=request.getContextPath()%>/quickloud-master/admin/adminGoodsOneForm.jsp?goodsNo=<%=goodsNo%>"><button
											type="button" id="submit1"
											class="btn btn-light btn-radius btn-brd grd1 btn-block">상세페이지로</button></a>
								</div>
