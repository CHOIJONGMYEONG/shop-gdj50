...
<body class="host_version">
	...
	<div class="section lb">
		...
		<div class="container">
			<a
				href="<%=request.getContextPath()%>/quickloud-master/admin/addGoodsForm.jsp"><button
					class="btn grd1 effect-1 btn-radius btn-brd">상품추가</button></a>
			<div class="section-title text-center">
							...
							<tbody>
								...
								<tr>
									...
									<td data-label="DOMAIN NAME"><a
										href="<%=request.getContextPath()%>/quickloud-master/admin/adminGoodsOneForm.jsp?goodsNo=<%=a.getGoodsNo()%>"><button
												class="btn btn-success"><%=a.getGoodsName()%></button></a></td>

									<td data-label="DOMAIN NAME"><%=a.getGoodsPrice()%></td>

									<td data-label="DOMAIN NAME"><%=a.getCreateDate()%></td>
									<td data-label="DOMAIN NAME"><%=a.getUpdateDate()%></td>
									<td data-label="DOMAIN NAME">
										<form
											action="<%=request.getContextPath()%>/quickloud-master/admin/adminSoldOutUpdateAction.jsp"
											method="post">
											<select name="soldOut"
											...
											%>
											<input type="hidden" value="<%=a.getGoodsNo()%>"
												name="goodsNo">
											<button type="submit"
												class="btn grd1 effect-1 btn-radius btn-brd">상태변경</button>
										</form>
									</td>
								</tr>
				...
				<a class="btn grd1 effect-1 btn-radius btn-brd"
					href="<%=request.getContextPath()%>/quickloud-master/admin/adminGoodsList.jsp?currentPage=<%=pageBegin - rowPerPage%>">이전</a>
				...
				%>
				<a class="btn grd1 effect-1 btn-radius btn-brd"
					href="<%=request.getContextPath()%>/quickloud-master/admin/adminGoodsList.jsp?currentPage=<%=i%>"><%=i%></a>
				<%
				}
				...
				<a class="btn grd1 effect-1 btn-radius btn-brd"
					href="<%=request.getContextPath()%>/quickloud-master/admin/adminGoodsList.jsp?currentPage=<%=pageBegin + rowPerPage%>">다음</a>
				<%
				}
				%>
