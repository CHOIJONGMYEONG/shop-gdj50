		...
		<div class="container">
			<div class="section-title text-center">
				<h3>리뷰쓰기</h3>
					...
					<form action="<%=request.getContextPath()%>/quickloud-master/customerReviewAction.jsp">
						...
						<div class="form-group">
							...
							<button type="submit" class="btn grd1 effect-1 btn-radius btn-brd">작성</button>
							<a class="btn grd1 effect-1 btn-radius btn-brd"
				href="<%=request.getContextPath()%>/quickloud-master/customerOrderList.jsp">주문목록</a>
					</form>
			</div>
