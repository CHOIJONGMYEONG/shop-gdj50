...
// listll
List<Map<String, Object>> list = goodsService.selectCustomerHighGoodsListByPage(rowPerPage, currentPage);
						...
						<div class="col-md-12">
							<div class="list-domain">
								<ul>
									...
									<li>
									<form name="rowform" action="<%=request.getContextPath()%>/quickloud-master/customerGoodsListHighPrice.jsp" method="post">
